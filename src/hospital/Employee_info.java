...
public class Employee_info extends JFrame {
    ...
    Employee_info(){
        ...
        JLabel  l1 = new JLabel("EMPLOYEE INFO");
        ...
        try {
            ...
            while (rs.next()) {
                model.addRow(new Object[] { rs.getString("Name"), rs.getString("Age"), rs.getString("Phone_Number"), rs.getString("salary"), rs.getString("Gmail"), rs.getString("Aadhar_Number") });
            }
